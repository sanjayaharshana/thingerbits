...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'next_text' => __('<span class=" fa fa-chevron-right"></span>','Thingerbits'),
		'prev_text' => __('<span class="fa fa-chevron-left"></span>','Thingerbits'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','Thingerbits'),
		'last_text' => __('','Thingerbits'),
		'next_text' => __('<span class="icon-chevron-right"></span>','Thingerbits'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Thingerbits'),
		'dotright_text' => __('...','Thingerbits'),
		'dotleft_text' => __('...','Thingerbits'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
